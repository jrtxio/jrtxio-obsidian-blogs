---
{"dg-publish":true,"dg-path":"IAR 烧写芯驰 E3 该如何配置.md","permalink":"/IAR 烧写芯驰 E3 该如何配置/","dg-note-properties":{"author":"吉人","tags":null,"created":"2026-04-06","source":null}}
---

> 读完这篇，你能用 IAR 完成芯驰 E3 的链接配置和烧写。

## 链接文件

通过链接文件可以指定程序的代码和数据在内存空间的位置。

![Pasted image 20250208134854.png\|650](/img/user/0.asset/media/Pasted%20image%2020250208134854.png)
...
![Pasted image 20250208135127.png\|650](/img/user/0.asset/media/Pasted%20image%2020250208135127.png)
...
![Pasted image 20250208135552.png\|650](/img/user/0.asset/media/Pasted%20image%2020250208135552.png)
