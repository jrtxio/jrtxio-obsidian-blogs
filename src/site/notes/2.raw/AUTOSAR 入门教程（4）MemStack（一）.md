---
{"dg-publish":true,"dg-path":"AUTOSAR 入门教程（4）MemStack（一）.md","permalink":"/AUTOSAR 入门教程（4）MemStack（一）/","dg-note-properties":{"author":null,"created":"2025-04-13","source":"https://sandeeptiwari.com/MemoryStack1.html","slug":"autosar-tutorial-4-memstack-1"}}
---
...
![nvm-single-block-flow.png\|500](/img/user/0.asset/media/nvm-single-block-flow.png)
