---
{"dg-publish":true,"dg-path":"Obsidian 的 Callout 使用场景.md","permalink":"/Obsidian 的 Callout 使用场景/","dg-note-properties":{"slug":"obsidian-callout-use-cases","author":"吉人","created":"2024-08-21","source":null}}
---

> 13 种 Callout 类型的语法和使用场景一览。
