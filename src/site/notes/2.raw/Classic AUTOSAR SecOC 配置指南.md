---
{"dg-publish":true,"dg-path":"Classic AUTOSAR SecOC 配置指南.md","permalink":"/Classic AUTOSAR SecOC 配置指南/","dg-note-properties":{"slug":"autosar-secoc-config","author":"吉人","created":"2026-04-06","source":null}}
---

> 读完这篇，你能独立完成 SecOC 模块的配置和集成。
...
![classic-autosar-secoc-fig02.png\|350](/img/user/0.asset/media/classic-autosar-secoc-fig02.png)
...
![classic-autosar-secoc-fig01.png\|650](/img/user/0.asset/media/classic-autosar-secoc-fig01.png)

如下所示，导入之后 DaVinci CFG 中会自动生成 SecOC 的相关内容。不过 SecOC 相关的模块 CSM、CryIf 等依然是需要自己手动配置的。

![classic-autosar-secoc-fig03.png\|350](/img/user/0.asset/media/classic-autosar-secoc-fig03.png)
