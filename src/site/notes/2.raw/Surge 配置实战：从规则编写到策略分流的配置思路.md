---
{"dg-publish":true,"dg-path":"Surge 配置实战：从规则编写到策略分流的配置思路.md","permalink":"/Surge 配置实战：从规则编写到策略分流的配置思路/","dg-note-properties":{"slug":"surge-config-tutorial","author":"吉人","created":"2024-04-06","source":null}}
---

> 我的 Surge 配置思路：规则设计的核心逻辑和具体含义。
