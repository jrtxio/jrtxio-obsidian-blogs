---
{"dg-publish":true,"dg-path":"vsomeip 从入门到精通.md","permalink":"/vsomeip 从入门到精通/","dg-note-properties":{"slug":"vsomeip-from-entry-to-mastery","author":"吉人","created":"2026-04-06","source":null}}
---

> 从 Boost.Asio 到 vsomeip 架构，系统化学习开源 SOME/IP 协议栈。

## 知识体系

![vsomeip-guide-fig08.png\|300](/img/user/0.asset/media/vsomeip-guide-fig08.png)
...
![vsomeip-guide-fig07.png\|550](/img/user/0.asset/media/vsomeip-guide-fig07.png)
### 多态应用场景

![vsomeip-guide-fig03.png\|350](/img/user/0.asset/media/vsomeip-guide-fig03.png)
...
![vsomeip-guide-fig02.png\|550](/img/user/0.asset/media/vsomeip-guide-fig02.png)
...
![vsomeip-guide-fig01-1.png\|650](/img/user/0.asset/media/vsomeip-guide-fig01-1.png)
...
![vsomeip-guide-fig01.png\|300](/img/user/0.asset/media/vsomeip-guide-fig01.png)
...
![vsomeip-someip-guide-fig05.png\|650](/img/user/0.asset/media/vsomeip-someip-guide-fig05.png)

![vsomeip-guide-fig04.png\|650](/img/user/0.asset/media/vsomeip-guide-fig04.png)
...
![vsomeip-someip-guide-fig01.png\|650](/img/user/0.asset/media/vsomeip-someip-guide-fig01.png)

我们可以再看一下 service entry 和 eventgroup entry 的报文结构，除了最后 4 个字节不一样，前面都是相同的，所以自然就可以设计出其中的继承结构。

![vsomeip-someip-guide-fig02.png\|650](/img/user/0.asset/media/vsomeip-someip-guide-fig02.png)

![vsomeip-someip-guide-fig03.png\|650](/img/user/0.asset/media/vsomeip-someip-guide-fig03.png)

我们再来看一下 ipv4、ipv6 等 option 的结构，前面的字段也是相同的。自然也可以提取出类似的继承关系。

![vsomeip-someip-guide-fig04.png\|650](/img/user/0.asset/media/vsomeip-someip-guide-fig04.png)

根据上面的报文结构分析，我们再来看一下 service discovery 报文的类图就很容易理解了。

![vsomeip-guide-fig05.png\|650](/img/user/0.asset/media/vsomeip-guide-fig05.png)

### endpoint 交互模块分析

![vsomeip-guide-fig06.png\|650](/img/user/0.asset/media/vsomeip-guide-fig06.png)
