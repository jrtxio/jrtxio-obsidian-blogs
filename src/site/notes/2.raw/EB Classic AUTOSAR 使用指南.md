---
{"dg-publish":true,"dg-path":"EB Classic AUTOSAR 使用指南.md","permalink":"/EB Classic AUTOSAR 使用指南/","dg-note-properties":{"slug":"eb-classic-autosar-guide","author":"吉人","created":"2024-04-06","source":null}}
---

> 读完这篇，你能用 EB tresos 搭建和编译 Classic AUTOSAR 工程。
...
![eb-launch-make-build.png\|650](/img/user/0.asset/media/eb-launch-make-build.png)

之后通过运行 launch 文件即可看到如下信息，执行 make 命令即可开始编译。

![eb-makefile-design-overview.png\|650](/img/user/0.asset/media/eb-makefile-design-overview.png)
