---
{"dg-publish":true,"dg-path":"AUTOSAR 入门教程（15）Gateway.md","permalink":"/AUTOSAR 入门教程（15）Gateway/","dg-note-properties":{"author":null,"created":"2025-04-23","source":"https://sandeeptiwari.com/Gateway.html","slug":"autosar-tutorial-15-gateway"}}
---
...
信号网关通过 **COM 模块** 实现信号/信号组的跨总线传输，核心特性包括：

- **映射机制**：1 个接收信号可映射到多个发送信号
- **即时触发**：收到即转发，无内容依赖性
- **配置要点**：
	- 使用 `ComGwMapping` 容器静态配置
	- 处理函数为 `Com_MainFunctionRouteSignals`

> 示例：CAN 总线的车速信号同时转发到 LIN 和 FlexRay 总线

## PDU 网关：PDUR 模块的高效数据搬运

PDU 网关通过 **PDUR 模块** 实现协议数据单元的跨协议传输，核心特性包括：
