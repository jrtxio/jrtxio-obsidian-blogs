---
{"dg-publish":true,"dg-path":"Digital Garden 接入 AdSense 教程.md","permalink":"/Digital Garden 接入 AdSense 教程/","dg-note-properties":{"slug":"digital-garden-adsense","author":"吉人","created":"2025-04-11","source":null}}
---

> 在 Digital Garden 博客中接入 AdSense 的完整操作流程。

参考[[Google AdSense 博客接入指南\|Google AdSense 博客接入指南]]文章了解添加的整个流程，以下文章不再讲解这部分内容。仅专注于 Digital Obsidian Garden 博客中添加的具体操作。
