---
{"dg-publish":true,"dg-path":"S32G CAN_43_LLCE 调试经验总结.md","permalink":"/S32G CAN_43_LLCE 调试经验总结/","dg-note-properties":{"slug":"s32g-can-llce-debug-notes","author":"吉人","created":"2024-04-06","source":null}}
---

> NXP S32G LLCE CAN 驱动的调试要点：固件加载和共享内存配置。

![s32g-can43-llce-debug-fig02.png\|400](/img/user/0.asset/media/s32g-can43-llce-debug-fig02.png)
...
![s32g-can43-llce-debug-fig01.png\|650](/img/user/0.asset/media/s32g-can43-llce-debug-fig01.png)
...
```c
CAN_43_LLCE_START_SEC_SHAREDMEMORY
"Can_43_LLCE_MemMap.h"
ghs section bss=".can_43_llce_sharedmemory"
static volatile Llce_Can_SharedMemoryType Can_SharedMemory;
ghs section
CAN_43_LLCE_STOP_SEC_SHAREDMEMORY
"Can_43_LLCE_MemMap.h"
```
