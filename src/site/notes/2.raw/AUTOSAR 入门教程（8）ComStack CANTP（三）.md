---
{"dg-publish":true,"dg-path":"AUTOSAR 入门教程（8）ComStack CANTP（三）.md","permalink":"/AUTOSAR 入门教程（8）ComStack CANTP（三）/","dg-note-properties":{"author":null,"created":"2025-04-17","source":"https://sandeeptiwari.com/ComStack_CanTP.html","slug":"autosar-tutorial-8-comstack-cantp-3"}}
---

**CAN 传输协议（CANTP）** 是 AUTOSAR 中实现长报文多帧传输的关键模块，尤其在诊断通信（UDS/OBD）中不可或缺。本文将解析 CANTP 的分层架构、流控机制和诊断应用场景。

![cantp-autosar-com-stack-position.png\|图：CANTP 在 AUTOSAR 通信栈中的位置（位于服务层）\|650](/img/user/0.asset/media/cantp-autosar-com-stack-position.png)
