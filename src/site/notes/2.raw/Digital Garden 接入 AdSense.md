---
{"dg-publish":true,"dg-path":"Digital Garden 接入 AdSense.md","permalink":"/Digital Garden 接入 AdSense/","dg-note-properties":{"author":"吉人","created":"2025-04-11","source":null,"slug":"digital-garden-adsense"}}
---

> 在 Digital Garden 博客中接入 AdSense 的完整操作流程。

参考[[2.raw/Google AdSense 博客接入指南\|Google AdSense 博客接入指南]]文章了解添加的整个流程，以下文章不再讲解这部分内容。仅专注于 Digital Obsidian Garden 博客中添加的具体操作。

## 验证网站所有权

在 AdSense 中，所有权验证是第一步。Google 需要确认你拥有该域名，否则就可能出现冒用流量的情况。验证的方式有三种，我采用的是元标记方式进行验证。

在进行具体的操作之前，我们先来分析一下如何才能让 Digital Obsidian Garden 的所有网页都能添加上元标记的内容。
