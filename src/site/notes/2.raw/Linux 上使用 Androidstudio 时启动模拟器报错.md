---
{"dg-publish":true,"dg-path":"Linux 上使用 Androidstudio 时启动模拟器报错.md","permalink":"/Linux 上使用 Androidstudio 时启动模拟器报错/","dg-note-properties":{"author":"吉人","created":"2016-04-06","source":null,"slug":"android-emulator-linux-fix"}}
---
