---
{"dg-publish":true,"dg-path":"王垠文章/Swift 语言的设计错误.md","permalink":"/王垠文章/Swift 语言的设计错误/","created":"2023-08-29T16:11:24.000+08:00","updated":"2023-12-12T14:38:33.967+08:00"}
---

#Technomous #王垠 

在『[[3.Archive/王垠文章/编程的智慧\|编程的智慧]]』一文中，我分析和肯定了 Swift 语言的 optional type 设计，但这并不等于 Swift 语言的整体设计是完美没有问题的。其实 Swift 1.0 刚出来的时候，我就发现它的 array 可变性设计存在严重的错误。Swift 2.0 修正了这个问题，然而他们的修正方法却没有击中要害，所以导致了其它的问题。这个错误一直延续到今天。
...
有人看了以上的内容，问我：“你说 Java 只有 reference type，但是根据 Java 的[官方文档](https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html)，Java 也有 value type 和 reference type 的区别的。” 由于这个问题相当的有趣，我另外写了一篇[[3.Archive/王垠文章/Java 有值类型吗？\|Java 有值类型吗？]]来回答这个问题。