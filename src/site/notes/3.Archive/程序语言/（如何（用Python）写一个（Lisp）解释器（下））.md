---
{"dg-publish":true,"dg-path":"程序语言/（如何（用Python）写一个（Lisp）解释器（下））.md","permalink":"/程序语言/（如何（用Python）写一个（Lisp）解释器（下））/","created":"2024-01-04T13:05:42.649+08:00","updated":"2024-01-04T14:03:41.622+08:00"}
---
