---
{"dg-publish":true,"dg-path":"03 Racket与函数式语言/Racket 语法指南：还在为函数式编程缺乏状态而困扰？用 Racket 闭包实现对象模拟.md","permalink":"/03 Racket与函数式语言/Racket 语法指南：还在为函数式编程缺乏状态而困扰？用 Racket 闭包实现对象模拟/"}
---
