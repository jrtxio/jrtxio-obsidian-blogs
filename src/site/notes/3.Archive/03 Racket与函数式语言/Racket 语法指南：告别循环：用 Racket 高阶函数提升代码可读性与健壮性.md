---
{"dg-publish":true,"dg-path":"03 Racket与函数式语言/Racket 语法指南：告别循环：用 Racket 高阶函数提升代码可读性与健壮性.md","permalink":"/03 Racket与函数式语言/Racket 语法指南：告别循环：用 Racket 高阶函数提升代码可读性与健壮性/"}
---
