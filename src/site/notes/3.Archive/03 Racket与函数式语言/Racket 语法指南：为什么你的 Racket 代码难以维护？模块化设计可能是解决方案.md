---
{"dg-publish":true,"dg-path":"03 Racket与函数式语言/Racket 语法指南：为什么你的 Racket 代码难以维护？模块化设计可能是解决方案.md","permalink":"/03 Racket与函数式语言/Racket 语法指南：为什么你的 Racket 代码难以维护？模块化设计可能是解决方案/"}
---
