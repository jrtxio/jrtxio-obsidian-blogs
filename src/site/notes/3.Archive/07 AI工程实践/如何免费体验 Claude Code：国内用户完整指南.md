...
> ⚠️ 前置条件：在开始之前，请确保你已经安装并配置好 Claude Code，安装过程可参考 [[3.Archive/07 AI工程实践/Claude Code 使用指南：安装、配置与实践\|Claude Code 使用指南：安装、配置与实践]]。
...
1. 确保 Claude Code 已经安装完成（可参考 [[3.Archive/07 AI工程实践/Claude Code 使用指南：安装、配置与实践\|Claude Code 使用指南：安装、配置与实践]]）
