---
{"dg-publish":true,"dg-path":"03 Racket与函数式编程/Noise 系列（十）：实战：从零构建 Swift + Racket 计算器应用.md","permalink":"/03 Racket与函数式编程/Noise 系列（十）：实战：从零构建 Swift + Racket 计算器应用/"}
---

#lisp/racket  #gui/noise

在[[Noise：跨语言嵌入的艺术\|上一篇文章]]中，我们剖析了 Noise 的实现原理。今天，我们来点实际的：**如何从零开始构建一个"计算器"应用，前端使用 SwiftUI，后端完全用 Racket 实现。**
