---
{"dg-publish":true,"dg-path":"03 Racket与函数式编程/【GUI】入门 Noise（一）：跨语言嵌入的艺术 - 三层架构与异步模型.md","permalink":"/03 Racket与函数式编程/【GUI】入门 Noise（一）：跨语言嵌入的艺术 - 三层架构与异步模型/"}
---
...
![[Pasted image 20260202212036.png\|650]]
