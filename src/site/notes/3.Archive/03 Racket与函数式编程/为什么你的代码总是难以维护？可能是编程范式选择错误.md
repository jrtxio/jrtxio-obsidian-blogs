---
{"dg-publish":true,"dg-path":"03 Racket与函数式编程/为什么你的代码总是难以维护？可能是编程范式选择错误.md","permalink":"/03 Racket与函数式编程/为什么你的代码总是难以维护？可能是编程范式选择错误/","title":"为什么你的代码总是难以维护？可能是编程范式选择错误","dg-note-properties":{"title":"为什么你的代码总是难以维护？可能是编程范式选择错误","cover":null,"author":"jrtxio","source_url":null}}
---
