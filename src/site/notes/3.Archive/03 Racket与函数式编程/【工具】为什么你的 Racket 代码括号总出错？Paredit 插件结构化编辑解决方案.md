---
{"dg-publish":true,"dg-path":"03 Racket与函数式编程/【工具】为什么你的 Racket 代码括号总出错？Paredit 插件结构化编辑解决方案.md","permalink":"/03 Racket与函数式编程/【工具】为什么你的 Racket 代码括号总出错？Paredit 插件结构化编辑解决方案/"}
---
...
> [!NOTE]
> 如果不了解快捷键的含义，可以参考这篇文章 [[DrRacket 入门指南：快捷键完全指南\|DrRacket 入门指南：快捷键完全指南]]
