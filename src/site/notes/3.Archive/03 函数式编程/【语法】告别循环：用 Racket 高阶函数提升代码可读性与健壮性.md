---
{"dg-publish":true,"dg-path":"03 函数式编程/【语法】告别循环：用 Racket 高阶函数提升代码可读性与健壮性.md","permalink":"/03 函数式编程/【语法】告别循环：用 Racket 高阶函数提升代码可读性与健壮性/","dg-note-properties":{"title":null,"cover":null,"author":"jrtxio"}}
---
