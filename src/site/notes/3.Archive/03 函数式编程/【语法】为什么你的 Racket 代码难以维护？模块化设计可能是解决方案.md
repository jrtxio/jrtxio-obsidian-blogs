---
{"dg-publish":true,"dg-path":"03 函数式编程/【语法】为什么你的 Racket 代码难以维护？模块化设计可能是解决方案.md","permalink":"/03 函数式编程/【语法】为什么你的 Racket 代码难以维护？模块化设计可能是解决方案/","dg-note-properties":{"title":null,"cover":null,"author":"jrtxio"}}
---
