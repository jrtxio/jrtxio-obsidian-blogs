...
# 我的介绍
我的专业是软件工程，目前是一名嵌入式软件工程师。详细技能可以参考我的[[3.Archive/简历\|简历]]。我希望未来能成为一名真全栈工程师。从硬件设计到软件驱动，从软件驱动到操作系统，从操作系统到软件架构，从软件架构到应用软件。我深知人的精力是有限的，精通所有领域是不太现实的。我希望能够掌握各个领域的核心概念，精通部分领域。
