---
{"dg-publish":true,"dg-path":"03 编程语言与理论/DrRacket 结构化编辑实战：用 Paredit 插件提升 Lisp 开发效率.md","permalink":"/03 编程语言与理论/DrRacket 结构化编辑实战：用 Paredit 插件提升 Lisp 开发效率/"}
---
...
> [!NOTE]
> 如果不了解快捷键的含义，可以参考这篇文章 [[3.Archive/03 编程语言与理论/DrRacket 快捷键完全指南：从基础操作到高级自定义\|DrRacket 快捷键完全指南：从基础操作到高级自定义]]
