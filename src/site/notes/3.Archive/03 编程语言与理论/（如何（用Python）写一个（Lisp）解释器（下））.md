---
{"dg-publish":true,"dg-path":"03 编程语言与理论/（如何（用Python）写一个（Lisp）解释器（下））.md","permalink":"/03 编程语言与理论/（如何（用Python）写一个（Lisp）解释器（下））/","created":"2024-01-04T13:05:42.000+08:00","updated":"2025-11-25T15:40:33.000+08:00"}
---
