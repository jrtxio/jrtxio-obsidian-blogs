---
{"dg-publish":true,"dg-path":"技术文章/对称、非对称加密和 CA 认证的原理分析.md","permalink":"/技术文章/对称、非对称加密和 CA 认证的原理分析/","created":"2023-11-24T16:33:36.000+08:00","updated":"2023-12-27T10:09:24.162+08:00"}
---
...
![20231124164055.png|650](/img/user/0.Asset/resource/20231124164055.png)

# HTTPS 的做法-引入 CA 机构

为了解决上面说到的问题：客户端太信任他拿到的公钥。所以我们引入了第三方的 CA 机构。CA 机构出现之后，所有人就约定：我们只相信被 CA 机构信任的公钥（也就是下面说到的证书）

![20231124164141.png|650](/img/user/0.Asset/resource/20231124164141.png)
