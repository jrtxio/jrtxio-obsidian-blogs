---
{"dg-publish":true,"dg-path":"技术文章/中间件开发中的 Linux 高级命令.md","permalink":"/技术文章/中间件开发中的 Linux 高级命令/","created":"2023-12-13T16:10:03.643+08:00","updated":"2024-02-01T10:41:53.374+08:00"}
---
...
将挂载点为 `/app` 的设备内容复制到 `/opt/update/app.img`。
...
使用 `df` 命令查看挂载在 `/app` 目录下的文件系统信息，并通过 `grep` 过滤出包含 `/app` 的行。
