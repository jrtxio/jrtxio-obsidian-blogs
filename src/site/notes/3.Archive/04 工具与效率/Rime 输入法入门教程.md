---
{"dg-publish":true,"dg-path":"04 工具与效率/Rime 输入法入门教程.md","permalink":"/04 工具与效率/Rime 输入法入门教程/","title":"Rime 输入法入门教程","dg-note-properties":{"title":"Rime 输入法入门教程","cover":null,"author":"jrtxio","source_url":null}}
---
