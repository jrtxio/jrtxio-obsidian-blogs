---
{"dg-publish":true,"dg-path":"04 工具与效率/我的 Surge 配置和使用教程.md","permalink":"/04 工具与效率/我的 Surge 配置和使用教程/","title":"我的 Surge 配置和使用教程","dg-note-properties":{"title":"我的 Surge 配置和使用教程","cover":null,"author":"jrtxio"}}
---
