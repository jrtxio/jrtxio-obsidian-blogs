---
{"dg-publish":true,"dg-path":"软件工程/（如何（用Python）写一个（Lisp）解释器（下））.md","permalink":"/软件工程/（如何（用Python）写一个（Lisp）解释器（下））/","created":"2024-01-04T13:05:42.000+08:00","updated":"2024-11-21T18:33:27.570+08:00"}
---
