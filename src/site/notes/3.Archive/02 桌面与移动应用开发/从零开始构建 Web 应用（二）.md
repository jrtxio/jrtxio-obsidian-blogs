---
{"dg-publish":true,"dg-path":"02 桌面与移动应用开发/从零开始构建 Web 应用（二）.md","permalink":"/02 桌面与移动应用开发/从零开始构建 Web 应用（二）/"}
---

#web

这是我的从零开始构建 Web 应用系列的第二篇文章。如果你还没读过，[[3.Archive/02 桌面与移动应用开发/从零开始构建 Web 应用（一）\|第一部分]]可以在这里找到。你需要先读那篇。
