---
{"dg-publish":true,"dg-path":"02 桌面与移动应用开发/URL 原理与设计：从互联网地址到 REST API 的完整理解.md","permalink":"/02 桌面与移动应用开发/URL 原理与设计：从互联网地址到 REST API 的完整理解/","title":"URL 原理与设计：从互联网地址到 REST API 的完整理解"}
---
