---
{"dg-publish":true,"dg-path":"02 桌面与移动应用开发/Linux 上使用 Androidstudio 时启动模拟器报错.md","permalink":"/02 桌面与移动应用开发/Linux 上使用 Androidstudio 时启动模拟器报错/","title":"Linux 上使用 Androidstudio 时启动模拟器报错","dg-note-properties":{"title":"Linux 上使用 Androidstudio 时启动模拟器报错","cover":null,"author":"jrtxio","source_url":null}}
---
