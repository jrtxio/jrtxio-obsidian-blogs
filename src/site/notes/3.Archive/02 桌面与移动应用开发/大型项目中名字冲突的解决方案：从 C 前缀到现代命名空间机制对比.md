---
{"dg-publish":true,"dg-path":"02 桌面与移动应用开发/大型项目中名字冲突的解决方案：从 C 前缀到现代命名空间机制对比.md","permalink":"/02 桌面与移动应用开发/大型项目中名字冲突的解决方案：从 C 前缀到现代命名空间机制对比/","title":"大型项目中名字冲突的解决方案：从 C 前缀到现代命名空间机制对比"}
---
