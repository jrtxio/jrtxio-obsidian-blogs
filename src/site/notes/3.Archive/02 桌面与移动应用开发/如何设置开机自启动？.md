---
{"dg-publish":true,"dg-path":"02 桌面与移动应用开发/如何设置开机自启动？.md","permalink":"/02 桌面与移动应用开发/如何设置开机自启动？/","title":"如何设置开机自启动？","dg-note-properties":{"title":"如何设置开机自启动？","cover":null,"author":"jrtxio","source_url":null}}
---
