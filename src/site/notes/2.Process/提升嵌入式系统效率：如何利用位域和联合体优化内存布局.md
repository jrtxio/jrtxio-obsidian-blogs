---
{"dg-publish":true,"permalink":"/2.Process/提升嵌入式系统效率：如何利用位域和联合体优化内存布局/","title":"提升嵌入式系统效率：如何利用位域和联合体优化内存布局","dg-note-properties":{"title":"提升嵌入式系统效率：如何利用位域和联合体优化内存布局","cover":null,"author":"jrtxio"}}
---
